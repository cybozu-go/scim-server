...
func (nq *NamesQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (nq *NamesQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (nq *NamesQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (nq *NamesQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (nq *NamesQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (nq *NamesQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := nq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (nq *NamesQuery) GroupBy(field string, fields ...string) *NamesGroupBy {
	grbuild := &NamesGroupBy{config: nq.config}
...
func (nq *NamesQuery) Select(fields ...string) *NamesSelect {
	...
	selbuild := &NamesSelect{NamesQuery: nq}
	selbuild.label = names.Label
...
func (nq *NamesQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Names, error) {
	var (
		nodes       = []*Names{}
		withFKs     = nq.withFKs
		_spec       = nq.querySpec()
	...
	_spec.ScanValues = func(columns []string) ([]interface{}, error) {
		return (*Names).scanValues(nil, columns)
	}
