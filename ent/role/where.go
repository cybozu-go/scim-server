...
func Primary(v bool) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func DisplayIsNil() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func DisplayNotNil() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func PrimaryEQ(v bool) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPrimary), v))
	})
}
...
func PrimaryNEQ(v bool) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func PrimaryIsNil() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func PrimaryNotNil() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
