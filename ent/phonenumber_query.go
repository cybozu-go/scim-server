...
func (pnq *PhoneNumberQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pnq *PhoneNumberQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (pnq *PhoneNumberQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pnq *PhoneNumberQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (pnq *PhoneNumberQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (pnq *PhoneNumberQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := pnq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	client.PhoneNumber.Query().
//		Select(phonenumber.FieldDisplay).
//		Scan(ctx, &v)
//
func (pnq *PhoneNumberQuery) Select(fields ...string) *PhoneNumberSelect {
	pnq.fields = append(pnq.fields, fields...)
	selbuild := &PhoneNumberSelect{PhoneNumberQuery: pnq}
	selbuild.label = phonenumber.Label
