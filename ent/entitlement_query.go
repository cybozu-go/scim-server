...
func (eq *EntitlementQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (eq *EntitlementQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (eq *EntitlementQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (eq *EntitlementQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (eq *EntitlementQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (eq *EntitlementQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (eq *EntitlementQuery) GroupBy(field string, fields ...string) *EntitlementGroupBy {
	grbuild := &EntitlementGroupBy{config: eq.config}
...
func (eq *EntitlementQuery) Select(fields ...string) *EntitlementSelect {
	...
	selbuild := &EntitlementSelect{EntitlementQuery: eq}
	selbuild.label = entitlement.Label
