...
func (uu *UserUpdate) SetNames(u uuid.UUID) *UserUpdate {
	uu.mutation.SetNames(u)
	return uu
}

// SetNillableNames sets the "names" field if the given value is not nil.
func (uu *UserUpdate) SetNillableNames(u *uuid.UUID) *UserUpdate {
	if u != nil {
		uu.SetNames(*u)
	}
	return uu
...
func (uu *UserUpdate) SetNameID(id uuid.UUID) *UserUpdate {
	uu.mutation.SetNameID(id)
	return uu
}

// SetNillableNameID sets the "name" edge to the Names entity by ID if the given value is not nil.
func (uu *UserUpdate) SetNillableNameID(id *uuid.UUID) *UserUpdate {
	if id != nil {
		uu = uu.SetNameID(*id)
	}
	return uu
...
func (uu *UserUpdate) SetName(n *Names) *UserUpdate {
	return uu.SetNameID(n.ID)
}

// AddEntitlementIDs adds the "entitlements" edge to the Entitlement entity by IDs.
func (uu *UserUpdate) AddEntitlementIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) AddIMSIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) AddPhoneNumberIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) AddX509CertificateIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) AddX509Certificates(x ...*X509Certificate) *UserUpdate {
	...
	return uu.AddX509CertificateIDs(ids...)
}
...
func (uu *UserUpdate) RemoveEntitlementIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) RemoveIMSIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) RemovePhoneNumberIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) RemoveX509CertificateIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) RemoveX509Certificates(x ...*X509Certificate) *UserUpdate {
	...
	return uu.RemoveX509CertificateIDs(ids...)
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.X509CertificatesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := uu.mutation.RemovedX509CertificatesIDs(); len(nodes) > 0 && !uu.mutation.X509CertificatesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.X509CertificatesTable,
	...
	if nodes := uu.mutation.X509CertificatesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.X509CertificatesTable,
...
// SetNames sets the "names" field.
func (uuo *UserUpdateOne) SetNames(u uuid.UUID) *UserUpdateOne {
	uuo.mutation.SetNames(u)
	return uuo
}

// SetNillableNames sets the "names" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableNames(u *uuid.UUID) *UserUpdateOne {
	if u != nil {
		uuo.SetNames(*u)
	}
	return uuo
...
// SetNameID sets the "name" edge to the Names entity by ID.
func (uuo *UserUpdateOne) SetNameID(id uuid.UUID) *UserUpdateOne {
	uuo.mutation.SetNameID(id)
	return uuo
}

// SetNillableNameID sets the "name" edge to the Names entity by ID if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableNameID(id *uuid.UUID) *UserUpdateOne {
	if id != nil {
		uuo = uuo.SetNameID(*id)
	}
	return uuo
}

// SetName sets the "name" edge to the Names entity.
func (uuo *UserUpdateOne) SetName(n *Names) *UserUpdateOne {
	return uuo.SetNameID(n.ID)
}

// AddEntitlementIDs adds the "entitlements" edge to the Entitlement entity by IDs.
func (uuo *UserUpdateOne) AddEntitlementIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// AddIMSIDs adds the "IMS" edge to the IMS entity by IDs.
func (uuo *UserUpdateOne) AddIMSIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// AddPhoneNumberIDs adds the "phone_numbers" edge to the PhoneNumber entity by IDs.
func (uuo *UserUpdateOne) AddPhoneNumberIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// AddX509CertificateIDs adds the "x509_certificates" edge to the X509Certificate entity by IDs.
func (uuo *UserUpdateOne) AddX509CertificateIDs(ids ...uuid.UUID) *UserUpdateOne {
...
func (uuo *UserUpdateOne) AddX509Certificates(x ...*X509Certificate) *UserUpdateOne {
	...
	return uuo.AddX509CertificateIDs(ids...)
}
...
// RemoveEntitlementIDs removes the "entitlements" edge to Entitlement entities by IDs.
func (uuo *UserUpdateOne) RemoveEntitlementIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// RemoveIMSIDs removes the "IMS" edge to IMS entities by IDs.
func (uuo *UserUpdateOne) RemoveIMSIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// RemovePhoneNumberIDs removes the "phone_numbers" edge to PhoneNumber entities by IDs.
func (uuo *UserUpdateOne) RemovePhoneNumberIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// RemoveX509CertificateIDs removes the "x509_certificates" edge to X509Certificate entities by IDs.
func (uuo *UserUpdateOne) RemoveX509CertificateIDs(ids ...uuid.UUID) *UserUpdateOne {
...
func (uuo *UserUpdateOne) RemoveX509Certificates(x ...*X509Certificate) *UserUpdateOne {
	...
	return uuo.RemoveX509CertificateIDs(ids...)
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.X509CertificatesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.X509CertificatesTable,
	...
	if nodes := uuo.mutation.RemovedX509CertificatesIDs(); len(nodes) > 0 && !uuo.mutation.X509CertificatesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.X509CertificatesTable,
	...
	if nodes := uuo.mutation.X509CertificatesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.X509CertificatesTable,
