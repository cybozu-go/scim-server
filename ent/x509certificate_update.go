...
func (xu *X509CertificateUpdate) SetDisplay(s string) *X509CertificateUpdate {
	xu.mutation.SetDisplay(s)
	return xu
}

// SetNillableDisplay sets the "display" field if the given value is not nil.
func (xu *X509CertificateUpdate) SetNillableDisplay(s *string) *X509CertificateUpdate {
	if s != nil {
		xu.SetDisplay(*s)
	}
	return xu
...
func (xu *X509CertificateUpdate) ClearDisplay() *X509CertificateUpdate {
	xu.mutation.ClearDisplay()
	return xu
}

// SetPrimary sets the "primary" field.
func (xu *X509CertificateUpdate) SetPrimary(b bool) *X509CertificateUpdate {
	xu.mutation.SetPrimary(b)
	return xu
}

// SetNillablePrimary sets the "primary" field if the given value is not nil.
func (xu *X509CertificateUpdate) SetNillablePrimary(b *bool) *X509CertificateUpdate {
	if b != nil {
		xu.SetPrimary(*b)
	}
	return xu
...
func (xu *X509CertificateUpdate) ClearPrimary() *X509CertificateUpdate {
	xu.mutation.ClearPrimary()
	return xu
}

// SetType sets the "type" field.
func (xu *X509CertificateUpdate) SetType(s string) *X509CertificateUpdate {
	xu.mutation.SetType(s)
	return xu
}

// SetNillableType sets the "type" field if the given value is not nil.
func (xu *X509CertificateUpdate) SetNillableType(s *string) *X509CertificateUpdate {
	if s != nil {
		xu.SetType(*s)
	}
	return xu
...
func (xu *X509CertificateUpdate) ClearType() *X509CertificateUpdate {
	xu.mutation.ClearType()
	return xu
}
...
func (xu *X509CertificateUpdate) SetNillableValue(s *string) *X509CertificateUpdate {
	if s != nil {
		xu.SetValue(*s)
	}
	return xu
...
func (xu *X509CertificateUpdate) ClearValue() *X509CertificateUpdate {
	xu.mutation.ClearValue()
	return xu
}
...
func (xu *X509CertificateUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := xu.mutation.Display(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: x509certificate.FieldDisplay,
		})
	}
	if xu.mutation.DisplayCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: x509certificate.FieldDisplay,
		})
	}
	if value, ok := xu.mutation.Primary(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: x509certificate.FieldPrimary,
		})
	}
	if xu.mutation.PrimaryCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Column: x509certificate.FieldPrimary,
		})
	}
	if value, ok := xu.mutation.GetType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: x509certificate.FieldType,
		})
	}
	if xu.mutation.TypeCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: x509certificate.FieldType,
		})
...
// SetDisplay sets the "display" field.
func (xuo *X509CertificateUpdateOne) SetDisplay(s string) *X509CertificateUpdateOne {
	xuo.mutation.SetDisplay(s)
	return xuo
}

// SetNillableDisplay sets the "display" field if the given value is not nil.
func (xuo *X509CertificateUpdateOne) SetNillableDisplay(s *string) *X509CertificateUpdateOne {
	if s != nil {
		xuo.SetDisplay(*s)
	}
	return xuo
...
// ClearDisplay clears the value of the "display" field.
func (xuo *X509CertificateUpdateOne) ClearDisplay() *X509CertificateUpdateOne {
	xuo.mutation.ClearDisplay()
	return xuo
}

// SetPrimary sets the "primary" field.
func (xuo *X509CertificateUpdateOne) SetPrimary(b bool) *X509CertificateUpdateOne {
	xuo.mutation.SetPrimary(b)
	return xuo
}

// SetNillablePrimary sets the "primary" field if the given value is not nil.
func (xuo *X509CertificateUpdateOne) SetNillablePrimary(b *bool) *X509CertificateUpdateOne {
	if b != nil {
		xuo.SetPrimary(*b)
	}
	return xuo
...
// ClearPrimary clears the value of the "primary" field.
func (xuo *X509CertificateUpdateOne) ClearPrimary() *X509CertificateUpdateOne {
	xuo.mutation.ClearPrimary()
	return xuo
}

// SetType sets the "type" field.
func (xuo *X509CertificateUpdateOne) SetType(s string) *X509CertificateUpdateOne {
	xuo.mutation.SetType(s)
	return xuo
}

// SetNillableType sets the "type" field if the given value is not nil.
func (xuo *X509CertificateUpdateOne) SetNillableType(s *string) *X509CertificateUpdateOne {
	if s != nil {
		xuo.SetType(*s)
	}
	return xuo
...
// ClearType clears the value of the "type" field.
func (xuo *X509CertificateUpdateOne) ClearType() *X509CertificateUpdateOne {
	xuo.mutation.ClearType()
	return xuo
}
...
// SetNillableValue sets the "value" field if the given value is not nil.
func (xuo *X509CertificateUpdateOne) SetNillableValue(s *string) *X509CertificateUpdateOne {
	if s != nil {
		xuo.SetValue(*s)
	}
	return xuo
...
// ClearValue clears the value of the "value" field.
func (xuo *X509CertificateUpdateOne) ClearValue() *X509CertificateUpdateOne {
	xuo.mutation.ClearValue()
	return xuo
}
...
func (xuo *X509CertificateUpdateOne) Save(ctx context.Context) (*X509Certificate, error) {
	...
	if len(xuo.hooks) == 0 {
		...
		v, err := mut.Mutate(ctx, xuo.mutation)
		if err != nil {
			return nil, err
		}
		nv, ok := v.(*X509Certificate)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from X509CertificateMutation", v)
		}
		node = nv
	}
	return node, err
...
func (xuo *X509CertificateUpdateOne) sqlSave(ctx context.Context) (_node *X509Certificate, err error) {
	...
	if value, ok := xuo.mutation.Display(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: x509certificate.FieldDisplay,
	...
	if xuo.mutation.DisplayCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: x509certificate.FieldDisplay,
		})
	}
	if value, ok := xuo.mutation.Primary(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: x509certificate.FieldPrimary,
	...
	if xuo.mutation.PrimaryCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Column: x509certificate.FieldPrimary,
		})
	}
	if value, ok := xuo.mutation.GetType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: x509certificate.FieldType,
