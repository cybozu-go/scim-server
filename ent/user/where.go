...
func Names(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func Etag(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEtag), v))
	})
}
...
func NamesEQ(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldNames), v))
	})
}
...
func NamesNEQ(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func NamesIn(vs ...uuid.UUID) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NamesNotIn(vs ...uuid.UUID) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NamesGT(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func NamesGTE(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func NamesLT(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func NamesLTE(v uuid.UUID) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func NamesIsNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.IsNull(s.C(FieldNames)))
	})
}

// NamesNotNil applies the NotNil predicate on the "names" field.
func NamesNotNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NotNull(s.C(FieldNames)))
	})
}
...
func EtagNEQ(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldEtag), v))
	})
}
...
func EtagIn(vs ...string) predicate.User {
	...
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldEtag), v...))
	})
}
...
func EtagNotIn(vs ...string) predicate.User {
	...
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldEtag), v...))
	})
}
...
func EtagGT(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldEtag), v))
	})
}
...
func EtagGTE(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldEtag), v))
	})
}
...
func EtagLT(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldEtag), v))
	})
}
...
func EtagLTE(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldEtag), v))
	})
}
...
func EtagContains(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.Contains(s.C(FieldEtag), v))
	})
}
...
func EtagHasPrefix(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.HasPrefix(s.C(FieldEtag), v))
	})
}
...
func EtagHasSuffix(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.HasSuffix(s.C(FieldEtag), v))
	})
}
...
func EtagEqualFold(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EqualFold(s.C(FieldEtag), v))
	})
}
...
func EtagContainsFold(v string) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.ContainsFold(s.C(FieldEtag), v))
	})
}
...
func HasName() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2O, false, NameTable, NameColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasEntitlements() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(EntitlementsTable, FieldID),
...
func HasEntitlementsWith(preds ...predicate.Entitlement) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasPhoneNumbers() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(PhoneNumbersTable, FieldID),
...
func HasPhoneNumbersWith(preds ...predicate.PhoneNumber) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasX509Certificates() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(X509CertificatesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, X509CertificatesTable, X509CertificatesColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasX509CertificatesWith(preds ...predicate.X509Certificate) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(X509CertificatesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, X509CertificatesTable, X509CertificatesColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
