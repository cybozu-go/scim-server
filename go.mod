module github.com/cybozu-go/scim-server

go 1.18

require (
	entgo.io/ent v0.11.0
	github.com/cybozu-go/scim v0.0.0-20220810075143-056c075687e3
...
require (
	...
	github.com/lestrrat-go/mux v0.0.0-20220525044338-e2775b70cf3d // indirect
